      ...
      <section className="bg-[#111111] p-8 rounded-2xl text-white shadow-2xl relative overflow-hidden group">
        <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center gap-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
                ...
                <button className="bg-white/10 text-white font-bold uppercase tracking-wider py-3 px-6 rounded-xl hover:bg-white/20 transition-colors backdrop-blur-sm border border-white/10 text-sm">
                    Přispět
                </button>
            </div>
        </div>
